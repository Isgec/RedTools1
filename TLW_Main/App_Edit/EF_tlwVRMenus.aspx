...
<asp:FormView ID="FVtlwVRMenus"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr>
        <td class="alignright">
          <b><asp:Label ID="L_VRMenuID" runat="server" ForeColor="#CC6633" Text="VRMenuID :" /><span style="color:red">*</span></b>
        </td>
        <td>
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_ParentVRMenuID" runat="server" Text="VRMenuID :" /><span style="color:red">*</span>
        </td>
        <td>
          <LGM:LC_tlwVRMenus
            ID="F_ParentVRMenuID"
      ...
      <tr>
        <td class="alignright">
          <asp:Label ID="L_VRMenuType" runat="server" Text="VRMenuType :" /><span style="color:red">*</span>
        </td>
        <td>
